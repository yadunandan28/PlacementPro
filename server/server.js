// ============================================================
//  server.js  —  PlacementPro API Entry Point
// ============================================================

// ⚠️  MUST be line 1 — loads your .env file into process.env
...
if (missing.length) {
  ...
  console.error("👉  Create a .env file in the server/ folder (copy .env.example)");
